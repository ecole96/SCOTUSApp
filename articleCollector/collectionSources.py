...
class TopicSites:
    ...
    # topic site driver
    def collect(self,c,clf,v_text,v_title,v_simtext,tz,smm,gdrive):
        ...
        functionCalls = {
                            "Reuters":["Reuters",[1,1]], "CNN":["CNN"], "New York Times":["NYTimes"], "Washington Post":["WaPo"], "Politico":["Politico",[1,1]], "Fox News":["FoxNews"], 
                            ...
                            "NPR":["NPR"], "AP":["AP"], "Wall Street Journal":["WSJ",[1,1]]
                        }
...
class RSSFeeds:
    ...
    # driver
    def parseFeeds(self,c,clf,v_text,v_title,v_simtext,tz,smm,gdrive):
...
class NewsAPICollection:
    ...
    # driver
    def parseResults(self,c,clf,v_text,v_title,v_simtext,tz,smm,gdrive):
